...
public class Farmer : MonoBehaviour, IGoap
{
    ...
    public HashSet<KeyValuePair<string, object>> GetWorldState()
    {
        ...
        worldData.Add(new KeyValuePair<string, object>("canRest", TownInventory.Instance.produceAmount >= TownInventory.Instance.produceCapacity)); 
        return worldData;
    }
    ...
    {
        Debug.Log($"Farmer canRest? {TownInventory.Instance.produceAmount >= TownInventory.Instance.produceCapacity}");
        MoveAgent(_rest);
